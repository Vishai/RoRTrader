// Enhanced mock data for RoR Trader UI with detailed bot configurations
...
// Generate mock bots with complete data
export const mockBots: Bot[] = [
  ...
  },
  {
    id: '3',
    name: 'ETH DCA Bot',
    description: 'Dollar cost averaging strategy for Ethereum accumulation',
    status: 'paused',
    exchange: 'coinbase_pro',
    assetType: 'crypto',
    tradingMode: 'live',
    webhookUrl: 'https://api.ror-trader.com/webhook/bot-3/wh_sec_p7Qr5bN3wK8m2Xs9',
    webhookSecret: 'wh_sec_p7Qr5bN3wK8m2Xs9',
    positionSizing: {
      type: 'fixed',
      value: 500,
    },
  ...
  },
  {
    id: '4',
    name: 'SPY Options',
    description: 'Options trading strategy for SPY ETF with defined risk',
    status: 'active',
    exchange: 'alpaca',
    assetType: 'stocks',
    tradingMode: 'paper',
    webhookUrl: 'https://api.ror-trader.com/webhook/bot-4/wh_sec_j4Yt8mL2qP6n3Kw7',
    webhookSecret: 'wh_sec_j4Yt8mL2qP6n3Kw7',
    positionSizing: {
      type: 'fixed',
      value: 2000,
    },
  ...
  },
  {
    ...
    description: 'Momentum-based strategy for crypto pairs with volume filters',
    status: 'stopped',
    exchange: 'coinbase_pro',
    assetType: 'crypto',
    tradingMode: 'paper',
    webhookUrl: 'https://api.ror-trader.com/webhook/bot-5/wh_sec_h8Nm3pK7wQ2r5Lx4',
    webhookSecret: 'wh_sec_h8Nm3pK7wQ2r5Lx4',
    positionSizing: {
      type: 'percentage',
      value: 15,
    },
...
export const getActivitiesByBot = (botName: string): Activity[] => {
  return mockActivities.filter(activity => activity.botName === botName);
};

// Format symbol for display
export const formatSymbol = (symbol: string): string => {
  // Remove -USD suffix for crypto pairs
